...
char *MSG[] = {
	...
	"Wert:\n"
	"  h#    - Ändert die horizontale Bildgröße auf # Pixel. Beispiel: h500\n"
	"  h+#   - Vergrößert das Bild horizontal um # Pixel.    Beispiel: h+50\n"
	"  h-#   - Verkleinert das Bild horizontal um # Pixel.   Beispiel: h-50\n"
	"  v#\n  v+#\n  v-#   - Wie zuvor, allerdings vertikal.\n"
	"  @+#:# - Vergrößert das Bild in einer Dimension auf das Seitenverhältnis #:#.\n"
	"          Beispiel: @+16:9\n"
	"  @-#:# - Verkleinert das Bild in einer Dimension auf das Seitenverhältnis #:#.\n"
	"          Beispiel: @-16:9\n"
	"  %+#\n  %-#   - Vergrößert bzw. verkleinert das Bild in einer Dimension\n"
	"          auf das Seitenverhältnis #% (Breite/Höhe). Beispiel: %+133\n",
	"Fugensuche: ges. erm.   % Fu/s    Dauer  verstr.   verbl.",
	"Bild wird geöffnet.",
	" - Fehler beim Öffnen",
	" - kein PNG-Bild oder beschädigt",
	"Interner Fehler",
	"PNG lesen fehlgeschlagen",
	"Palette lesen fehlgeschlagen.",
	"Ungültige Dimensionsangabe.",
	"Seitenverhältnis erfordert Vorzeichen.",
	"Keine Größenänderung erforderlich.",
	"Ungültiger Größenparameter oder Null angegeben.",
	"Größenänderung übersteigt Bildmaße.",
	"Bild wird geladen.",
	"Bildmaße",
	"vertikal",
	"horizontal",
